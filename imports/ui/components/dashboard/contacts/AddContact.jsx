...
import {Row, Col, Glyphicon, Panel, Button, FormGroup, ControlLabel, FormControl, HelpBlock } from 'react-bootstrap';
              ...
              {this.state.validationSearch === 'success' ?
                  <Col lg={8} md={8}>
                    <Row className='addContactGroup'>
                      <Col lg={1} md={1}><Button bsStyle="primary" onClick={this.addContactHldr}>Add Contact</Button></Col>
                      <Col lg={2} md={2}></Col>
                      <Col lg={5} md={5}><h4>{this.state.findedName}</h4></Col>
                    </Row>
                  </Col>
              : ''}
