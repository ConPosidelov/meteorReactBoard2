...
class ProfileExt1Form extends React.Component {
  ...
  changeNicName = e => {
    ...
    if (val.length > 0 && (val.length < 4 || val.charAt(0) !== "@")) {
      this.setState({
        warning: "It requires a minimum of 4 characters & first @"
      });
    } else {
        ...
        <FormGroup>
          ...
          <Col sm={8}>
            <FormControl
              ...
              inputRef={ref => (this.i.fullName = ref)}
            />
          </Col>
        </FormGroup>
        <FormGroup>
          ...
          <Col sm={8}>
            <FormControl
              ...
              inputRef={ref => (this.i.organization = ref)}
            />
          </Col>
        </FormGroup>
        <FormGroup>
          ...
          <Col sm={8}>
            <FormControl
              type="text"
              placeholder="Country"
              inputRef={ref => (this.i.country = ref)}
            />
          </Col>
        </FormGroup>
        <FormGroup>
          ...
          <Col sm={8}>
            <FormControl
              ...
              inputRef={ref => (this.i.description = ref)}
            />
          </Col>
        </FormGroup>
