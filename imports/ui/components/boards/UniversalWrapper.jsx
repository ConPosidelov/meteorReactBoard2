    ...
    return (
      ...
      >
        <div
          ...
          style={{ ...pointStyle, ...leftTopStyle }}
        />
        <div
          className="controlPoint"
          style={{ ...pointStyle, ...leftBottomStyle }}
        />
        <div
          className="controlPoint"
          style={{ ...pointStyle, ...rightTopStyle }}
        />
        <div
          className="controlPoint"
          style={{ ...pointStyle, ...rightBottomStyle }}
        />

        <div className="controlPoint" style={{ ...pointStyle, ...topStyle }} />
        <div className="controlPoint" style={{ ...pointStyle, ...leftStyle }} />
        <div
          className="controlPoint"
          style={{ ...pointStyle, ...rightStyle }}
        />
        <div
          className="controlPoint"
          style={{ ...pointStyle, ...bottomStyle }}
        />
