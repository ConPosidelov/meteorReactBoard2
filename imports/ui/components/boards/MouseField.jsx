//  1- We catch the mouse and store the coordinates in the database
//  2- create a temporary element and work with it before saving to the database
//
...
class MouseField extends React.Component {
  ...
  render() {
    ...
    const midleElement = <div className="midleElement" style={midleElStyle} />;
